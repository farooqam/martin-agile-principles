...
namespace BigCorp.EmployeeDomainTests
{
    public class UnitedStatesAddressTests
    {
        ...
        {
            // Arrange
            var address1 = new UnitedStatesAddress("foo", "bar", "qux", "baz", "boo", "hee", "haw");
            var address2 = new UnitedStatesAddress("foo", "bar", "qux", "baz", "boo", "hee", "haw");
        ...
        {
            // Arrange
            var address1 = new UnitedStatesAddress(address1Values[0], address1Values[1], address1Values[2], address1Values[3], address1Values[4], address1Values[5], address1Values[6]);
            var address2 = new UnitedStatesAddress(address2Values[0], address2Values[1], address2Values[2], address2Values[3], address2Values[4], address2Values[5], address2Values[6]);
